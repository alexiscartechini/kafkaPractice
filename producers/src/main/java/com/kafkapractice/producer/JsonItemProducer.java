...
public class JsonItemProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JsonItemProducer.class);

    private static final String TEST_TOPIC = "test-topic";
    private final KafkaProducer<Integer, String> kafkaProducer;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public JsonItemProducer(Map<String, Object> producerProperties) {
        kafkaProducer = new KafkaProducer<>(producerProperties);
    }

    public static void main(String[] args) throws InterruptedException {
        JsonItemProducer messageProducer = new JsonItemProducer(buildProducerProperties());
